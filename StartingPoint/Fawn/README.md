...
<details> 
    <summary>
        ...
        <br>
        <blockquote cite="HINT">HINT</blockquote>
        <blockquote cite="HINT">
            <i>To get the ftp version we must use nmap with the -sV switch, which allows us to find out the software versions: nmap -sV $HTB_MACHINE_IP_ADRES</i>
        </blockquote>
    </summary>
    <br>
    <b>vsftpd 3.0.3</b>
